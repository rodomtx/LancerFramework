   ...
   <div class="mdl-grid ui-components">
       ...
       <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                   ...
                   <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="machinesn">
                                        <label class="mdl-textfield__label" for="first-name">Serie Maquina</label>
                                    </div>
                           
                        
                    <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-green" runat="server" OnClick="rwBusquedaMachineSN">
    ...
    <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                  ...
                  <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="coldplate">
                                        <label class="mdl-textfield__label" for="first-name">Serie coldplate</label>
                                    </div>
                             
                            
                             <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-green" runat="server" OnClick="rwBusquedaColdplateSN">
                                    <i class="material-icons">search</i>
    ...
    <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                  ...
                  <div class="mdl-textfield mdl-js-textfield full-size">
                                        <input class="mdl-textfield__input" type="text" id="retrabajo">
                                        <label class="mdl-textfield__label" for="first-name">Orden de retrabajo</label>
                                    </div>
                           
                         
                         <button class="mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-green" runat="server" OnClick="rwBusquedaRWID">
                                    <i class="material-icons">search</i>
